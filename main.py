...
configs = {
    ...
    "TRAIN_SIZE": 0.8,
    "FOLDER_PATH": "Weights/Final/cenario13/", 
    "FOLDER_DATA_PATH": "Weights/Final/cenario13/", 
...
def main():
    ...
    load_type_train, load_type_test, general_qtd_train, general_qtd_test = dataHandler.generateAcquisitionType(trainSize, augmentation=3)
    ...
    if EXECUTION_STATE == TRAIN:
        ...
        for train_index, test_index in kfold.split(X_all):
            ...
            # file_log = createLogger(folderPath) # Log
